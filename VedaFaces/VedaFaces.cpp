...
GGLIBRARY_API veda::VedaFaces* veda::CreateFace(std::string conifgDir) {
    return new veda::VedaFaces(conifgDir);
}
...
void veda::VedaFaces::ProcessImage(dlib::array2d<bgr_pixel>& img) {
